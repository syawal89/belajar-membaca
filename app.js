...
function sequence(w){const syl=syllables(w),out=[];for(const s of syl){for(const c of s)out.push({show:c,speak:letterSound[c]||c,letter:true});out.push({show:s,speak:s,letter:false})}out.push({show:w,speak:w,letter:false});return out}
